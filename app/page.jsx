...
const content = {
  tr: {
    ...
    aboutUsHighlights: [
      { title: "Kişiye Özel Planlama", text: "Medikal ihtiyaç, seyahat takvimi ve konfor beklentisi tek dosyada değerlendirilir.", icon: "consult", image: "https://images.unsplash.com/photo-1576091160550-2173dba999ef?auto=format&fit=crop&w=900&q=80" },
      { title: "Yetkili Kurum Ağı", text: "Hastane, klinik, hekim, tercüman ve transfer ekipleri tek merkezden koordine edilir.", icon: "building", image: "https://images.unsplash.com/photo-1586773860418-d37222d8fce3?auto=format&fit=crop&w=900&q=80" },
      { title: "Sonrası Takip", text: "Kontrol hatırlatmaları, bakım önerileri ve uzaktan destekle yolculuk tedavi sonrasında da sürer.", icon: "support", image: "https://images.unsplash.com/photo-1579684385127-1ef15d508118?auto=format&fit=crop&w=900&q=80" }
    ],
        ...
        <div className="fixed bottom-24 right-6 z-50 w-[320px] rounded-2xl border border-slate-200 bg-white p-4 shadow-2xl">
          <div className="mb-3 flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Image src="/temsilci.png" alt="Lina temsilci" width={32} height={32} className="h-8 w-8 rounded-full object-cover" />
              <div>
