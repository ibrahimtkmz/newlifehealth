...
const CONTENT = {
  ...
  ar: {
    title: "مدونة",
    subtitle: "محتوى موثوق وعملي لتخطيط العلاج والتحضير للسفر والتعافي بعد العملية.",
    featuredLabel: "مميز",
    ...
    featured: {
      title: "دليل التحضير للسياحة الصحية",
      excerpt: "قائمة تحقق شاملة للسجلات وتخطيط السفر وإعداد الدواء والمراحل التنظيمية قبل القدوم إلى تركيا.",
      category: "preparation",
      date: "15 مارس 2024",
      readTime: "8"
    },
    posts: [
      {
        title: "أول 7 أيام بعد زراعة الشعر",
        excerpt: "خطوات العناية الأساسية: التحكم في التورم وبروتوكول الغسيل والعودة الآمنة للحياة اليومية.",
        category: "hairTransplant",
        date: "10 مارس 2024",
        readTime: "6"
      },
      {
        title: "ما هو تصميم الابتسامة الرقمي؟",
        excerpt: "كيف تساعد أدوات المحاكاة الحديثة على التنبؤ بالنتائج الجمالية قبل بدء العلاج.",
        category: "dental",
        date: "5 مارس 2024",
        readTime: "5"
      },
      {
        title: "تجميل الأنف: التوقعات والواقع",
        excerpt: "ما تحتاج معرفته قبل جراحة الأنف وعملية التعافي ونصائح للحصول على نتائج طبيعية.",
        category: "plastic",
        date: "28 فبراير 2024",
        readTime: "7"
      },
      {
        title: "التغذية بعد عملية تكميم المعدة",
        excerpt: "برنامج التغذية بعد العملية والمكملات الغذائية وعادات الحياة الصحية.",
        category: "bariatric",
        date: "20 فبراير 2024",
        readTime: "6"
      },
      {
        title: "عطلة علاجية في إسطنبول",
        excerpt: "الجمع بين السياحة الطبية والاستكشاف الثقافي: استمتع بإسطنبول خلال علاجك.",
        category: "travel",
        date: "15 فبراير 2024",
        readTime: "4"
      },
      {
        title: "FUE مقابل DHI: أي تقنية تناسبك؟",
        excerpt: "مقارنة بين تقنيتين شائعتين لزراعة الشعر ومزاياهما وعيوبهما.",
        category: "hairTransplant",
        date: "10 فبراير 2024",
        readTime: "5"
      }
    ...
    tips: [
      "أوقف تناول أدوية تخفيف الدم قبل العلاج بأسبوعين",
      "تحقق من صلاحية جواز سفرك",
      "اختر ملابس مريحة وحذاءً سهل الارتداء",
      "احتفظ بنسخة رقمية من سجلاتك الطبية"
    ]
  },
  ru: {
    title: "Блог",
