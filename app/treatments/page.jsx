...
const CONTENT = {
  ...
  ru: {
    ...
    whyUsItems: [
      "Экспертная медицинская команدа с международными сертификатами",
  ...
  ar: {
    title: "العلاجات",
    subtitle: "حلول متخصصة وفق معايير دولية. فريقنا الطبي المتخصص وبنيتنا التحتية الحديثة في خدمتك.",
    intro: "اكتشف جميع خدماتنا الطبية واختر تخصص العلاج المناسب بثقة.",
    labels: {
      hair: "زراعة الشعر",
      dental: "تجميل الأسنان",
      plastic: "الجراحة التجميلية",
      bariatric: "جراحة السمنة"
    },
    descriptions: {
      hair: "مظهر طبيعي ونتائج دائمة بتقنيات Sapphire FUE وDHI. إجراء غير مؤلم وتعافي سريع.",
      dental: "قشرة زركونية وزراعة وابتسامة هوليوود. نتائج مثالية بالتخطيط الرقمي.",
      plastic: "تجميل الأنف وشد الوجه وتجميل الثدي وتشكيل الجسم. إجراءات آمنة مع جراحين متخصصين.",
      bariatric: "بوتوكس المعدة وتكميم المعدة والتحويل المعدي. سيطرة دائمة على الوزن وحياة صحية."
    },
    stats: {
      hair: { duration: "6-8 ساعات", recovery: "3-7 أيام", success: "97%" },
      dental: { duration: "3-5 أيام", recovery: "2-4 أيام", success: "98%" },
      plastic: { duration: "2-6 ساعات", recovery: "7-14 يوماً", success: "95%" },
      bariatric: { duration: "30 دق - 2 ساعة", recovery: "5-10 أيام", success: "93%" }
    },
    duration: "مدة العلاج",
    recovery: "التعافي",
    success: "نسبة النجاح",
    ...
    compareHeaders: ["العلاج", "الميزة الرئيسية", "الإقامة في تركيا"],
    compareRows: [
      ["زراعة الشعر", "كثافة طبيعية + ندوب أدنى", "3 أيام"],
      ["تجميل الأسنان", "تحول جمالي سريع", "4-6 أيام"],
      ["الجراحة التجميلية", "خطة مخصصة + سلامة المستشفى", "7-10 أيام"],
      ["جراحة السمنة", "تحسن دائم للصحة الايضابية", "5-7 أيام"]
    ],
    certTitle: "الشهادات والاعتمادات",
    certs: ["اعتماد JCI", "جودة الرعاية الصحية ISO 9001", "رخصة TURSAB للسياحة الصحية", "تصريح وزارة الصحة للمرضى الدوليين"],
    whyUsTitle: "لماذا تختارنا؟",
    whyUsItems: [
      "فريق طبي متخصص بشهادات دولية",
      "بنية تحتية حديثة بأحدث التقنيات",
      "خطط علاج مخصصة",
      "خط دعم المرضى 24/7",
      "متابعة واستشارة ما بعد العملية"
    ]
  }
};
