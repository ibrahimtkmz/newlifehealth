...
const CONTENT = {
  ...
  ar: {
    title: "خدمات VIP",
    subtitle: "تجربة مريض فاخرة تجمع بين الراحة والسرعة والتنسيق الشخصي في كل مرحلة من رحلتك.",
    processTitle: "مسار VIP لدينا",
    steps: [
      {
        icon: Phone,
        title: "التحضير قبل الوصول",
        description: "استشارة عبر الإنترنت ومراجعة الملف الطبي وتقييم الأهلية. إعداد خطة علاج مخصصة."
      },
      {
        icon: Plane,
        title: "لوجستيات السفر",
        description: "استقبال في المطار ونقل خاص ومساعدة في تسجيل الفندق. استقبال VIP في المطار."
      },
      {
        icon: Stethoscope,
        title: "يوم العملية",
        description: "مترجم ومستشار ومنسق العيادة في سيرورة واحدة. مرافقة المريض بدوام."
      },
      {
        icon: Hotel,
        title: "راحة التعافي",
        description: "إقامة في فندق 5 نجوم وجدول مراجعات طبية وخطة أدوية ونصائح راحة مخصصة."
      },
      {
        icon: HeartPulse,
        title: "متابعة طويلة الأمد",
        description: "مراقبة عن بُعد بالصور والفيديو بعد عودتك. دعم مدى الحياة."
      }
    ],
    servicesTitle: "الخدمات المشمولة",
    services: [
      { icon: Car, title: "نقل VIP", description: "نقل مطار-فندق-مستشفى بسيارات فاخرة" },
      { icon: Hotel, title: "إقامة 5 نجوم", description: "غرف مريحة في فنادق فاخرة" },
      { icon: Languages, title: "دعم الترجمة", description: "مساعدة مترجم محترف على مدار 24/7" },
      { icon: Crown, title: "منسق شخصي", description: "ممثل مريض مخصص لك" }
    ],
    packagesTitle: "باقات VIP لدينا",
    packages: [
      {
        name: "Silver",
        features: ["نقل مطار", "فندق 4 نجوم 3 ليالي", "دعم الترجمة", "تنسيق العلاج", "متابعة عن بُعد"]
      },
      {
        name: "Gold",
        features: ["استقبال VIP في المطار", "فندق 5 نجوم 5 ليالي", "مترجم 24/7", "منسق شخصي", "جولة إسطنبول", "متابعة موسعة"]
      },
      {
        name: "Platinum",
        features: ["خيار طائرة خاصة", "إقامة سويت فندقية", "مساعد شخصي 24/7", "تأجير سيارة فاخرة", "خدمة طاهي خاص", "تأمين صحي VIP", "متابعة مدى الحياة"]
      }
    ],
    ctaTitle: "خطط لتجربتك VIP",
    ctaText: "تواصل معنا لإنشاء باقة VIP مخصصة لك."
  }
};
