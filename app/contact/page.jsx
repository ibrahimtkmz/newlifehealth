...
const CONTENT = {
  tr: {
    ...
    address: "Nispetiye Cad. No: 22, Besiktas / Istanbul",
    phoneNumber: "+90 212 000 00 00",
    whatsappNumber: "+90 500 000 00 00",
    emailAddress: "info@nlsaglikturizmi.com",
    hours: [
  ...
  en: {
    ...
    address: "Nispetiye St. No: 22, Besiktas / Istanbul",
    phoneNumber: "+90 212 000 00 00",
    whatsappNumber: "+90 500 000 00 00",
    emailAddress: "info@nlsaglikturizmi.com",
    hours: [
  ...
  ru: {
    ...
    address: "Nispetiye Cad. No: 22, Besiktas / Стамбул",
    phoneNumber: "+90 212 000 00 00",
    whatsappNumber: "+90 500 000 00 00",
    emailAddress: "info@nlsaglikturizmi.com",
    hours: [
